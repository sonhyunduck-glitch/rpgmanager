...
const HAND_CURATED_TEMPLATES: Record<string, Omit<EquipmentTemplate, 'safeEnchant'> & { safeEnchant?: number }> = {
  ...
  */
  ...
  // ── 한손검 (8종) ──
  mail_breaker:        { id: 'mail_breaker',        name: '메일 브레이커',       type: 'weapon', baseAtk: 4,  baseAtkLarge: 5,  baseDef: 0, maxEnhance: 10,  sellPrice: 10,   bonuses: { hit: 10, undeadSlayer: true }, bonusEffects: ['명중+10', '언데드 추타'] },
  silver_sword:        { id: 'silver_sword',        name: '은검',               type: 'weapon', baseAtk: 7,  baseAtkLarge: 7,  baseDef: 0, maxEnhance: 10,  sellPrice: 900,   bonuses: { undeadSlayer: true }, bonusEffects: ['언데드 추타'] },
  silver_long_sword:   { id: 'silver_long_sword',   name: '은장검',             type: 'weapon', baseAtk: 8,  baseAtkLarge: 12, baseDef: 0, maxEnhance: 10,  sellPrice: 6500,   bonuses: { undeadSlayer: true }, bonusEffects: ['언데드 추타'] },
  damascus_sword:      { id: 'damascus_sword',      name: '다마스커스 검',       type: 'weapon', baseAtk: 10, baseAtkLarge: 11, baseDef: 0, maxEnhance: 10,  sellPrice: 2500,  bonuses: { unbreakable: true }, bonusEffects: ['손상되지 않음'] },
  katana:              { id: 'katana',              name: '일본도',             type: 'weapon', baseAtk: 10, baseAtkLarge: 12, baseDef: 0, maxEnhance: 10,  sellPrice: 10000,  bonuses: { hit: 1 }, bonusEffects: ['명중+1'] },
  rapier:              { id: 'rapier',              name: '레이피어',           type: 'weapon', baseAtk: 11, baseAtkLarge: 6,  baseDef: 0, maxEnhance: 10,  sellPrice: 150,  bonuses: { undeadSlayer: true }, bonusEffects: ['언데드 추타'] },
  oriharukon_sword:    { id: 'oriharukon_sword',    name: '싸울아비 장검',       type: 'weapon', baseAtk: 16, baseAtkLarge: 10, baseDef: 0, maxEnhance: 10,  sellPrice: 17500,  bonuses: { hit: 2 }, bonusEffects: ['명중+2'] },
  dk_flame_sword:      { id: 'dk_flame_sword',      name: '데스나이트의 불검',   type: 'weapon', baseAtk: 16, baseAtkLarge: 10, baseDef: 0, maxEnhance: 10,  sellPrice: 800,  bonuses: { hit: 5, extraDmg: 2, unbreakable: true }, bonusEffects: ['손상되지 않음', '명중+5', '추타+2'] },
  ...
  */
  leather_vest:            { id: 'leather_vest',            name: '가죽조끼',              type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 15 },
  leather_armor:           { id: 'leather_armor',           name: '가죽 갑옷',             type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 50 },
  orc_ring_mail:           { id: 'orc_ring_mail',           name: '오크족 고리 갑옷',       type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 100 },
  studded_vest:            { id: 'studded_vest',            name: '징박은 가죽조끼',        type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 35 },
  nameless_robe:           { id: 'nameless_robe',           name: '무명 로브',             type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 500,   bonuses: { mr: 4 }, bonusEffects: ['MR +4'] },
  ring_mail:               { id: 'ring_mail',               name: '고리 갑옷',             type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 250 },
  studded_leather_armor:   { id: 'studded_leather_armor',   name: '징박힌 가죽 갑옷',       type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 150 },
  belted_vest:             { id: 'belted_vest',             name: '벨트달린 가죽조끼',      type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 60 },
  wooden_armor:            { id: 'wooden_armor',            name: '나무 갑옷',             type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 55 },
  ...
  mr_chain_armor:          { id: 'mr_chain_armor',          name: '마법 방어 사슬 갑옷',    type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 5, maxEnhance: 10, sellPrice: 4000,  bonuses: { mr: 4 }, bonusEffects: ['MR +4'] },
  bone_armor:              { id: 'bone_armor',              name: '뼈갑옷',                type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 5, maxEnhance: 0, sellPrice: 1000 },
  blue_pirate_armor:       { id: 'blue_pirate_armor',       name: '푸른 해적 가죽갑옷',     type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 5, maxEnhance: 10, sellPrice: 200 },
  elven_chain_armor:       { id: 'elven_chain_armor',       name: '요정족 사슬 갑옷',       type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 5, maxEnhance: 10, sellPrice: 280 },
  band_armor:              { id: 'band_armor',              name: '띠 갑옷',               type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 6, maxEnhance: 10, sellPrice: 5750 },
  demon_armor:             { id: 'demon_armor',             name: '데몬의 갑옷',            type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 6, maxEnhance: 10, sellPrice: 21000 },
  heavy_scale_armor:       { id: 'heavy_scale_armor',       name: '중 비늘 갑옷',           type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 6, maxEnhance: 10, sellPrice: 320 },
  bronze_plate:            { id: 'bronze_plate',            name: '청동 판금 갑옷',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 6, maxEnhance: 10, sellPrice: 9000 },
  elven_plate:             { id: 'elven_plate',             name: '요정족 판금 갑옷',       type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 6, maxEnhance: 10, sellPrice: 450 },
  dk_armor:                { id: 'dk_armor',                name: '데스나이트의 갑옷',      type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 7, maxEnhance: 10, sellPrice: 600 },
  steel_plate_armor:       { id: 'steel_plate_armor',       name: '강철 판금 갑옷',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 7, maxEnhance: 10, sellPrice: 500 },
  plate_armor:             { id: 'plate_armor',             name: '판금 갑옷',             type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 7, maxEnhance: 10, sellPrice: 18500 },
  kurtz_armor:             { id: 'kurtz_armor',             name: '커츠의 갑옷',            type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 7, maxEnhance: 10, sellPrice: 1200 },
  phantom_armor:           { id: 'phantom_armor',           name: '환상의 갑옷',            type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 7, maxEnhance: 10, sellPrice: 800 },
  demon_lord_robe:         { id: 'demon_lord_robe',         name: '마령군왕의 로브',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 8, maxEnhance: 10, sellPrice: 1800 },
  crystal_armor:           { id: 'crystal_armor',           name: '수정 갑옷',             type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 8, maxEnhance: 10, sellPrice: 40000 },
  water_dragon_armor:      { id: 'water_dragon_armor',      name: '수룡 비늘 갑옷',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 9, maxEnhance: 10, sellPrice: 4500, bonusEffects: ['물 속성 저항+20 (미구현)'] },
  earth_dragon_armor:      { id: 'earth_dragon_armor',      name: '지룡 비늘 갑옷',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 9, maxEnhance: 10, sellPrice: 5000, bonusEffects: ['땅 속성 저항+20 (미구현)'] },
  wind_dragon_armor:       { id: 'wind_dragon_armor',       name: '풍룡 비늘 갑옷',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 9, maxEnhance: 10, sellPrice: 5500, bonusEffects: ['바람 속성 저항+20 (미구현)'] },
  fire_dragon_armor:       { id: 'fire_dragon_armor',       name: '화룡 비늘 갑옷',         type: 'armor', baseAtk: 0, baseAtkLarge: 0, baseDef: 9, maxEnhance: 10, sellPrice: 8000, bonusEffects: ['불 속성 저항+20 (미구현)'] },
  ...
  */
  leather_hat:             { id: 'leather_hat',             name: '가죽모자',           type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 0, maxEnhance: 10, sellPrice: 10 },
  leather_helmet:          { id: 'leather_helmet',          name: '가죽투구',           type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 25 },
  steel_helm:              { id: 'steel_helm',              name: '강철 면갑',           type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 300 },
  dwarf_iron_helm:         { id: 'dwarf_iron_helm',         name: '난쟁이족 철 투구',     type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 250 },
  demon_helm:              { id: 'demon_helm',              name: '데몬의 투구',         type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 200 },
  dk_helmet:               { id: 'dk_helmet',               name: '데스나이트의 투구',    type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 1500 },
  mr_helm:                 { id: 'mr_helm',                 name: '마법 방어 투구',       type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 1250,  bonuses: { mr: 4 }, bonusEffects: ['MR +4'] },
  mugwan_helm:             { id: 'mugwan_helm',             name: '무관의 투구',          type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 1750 },
  baranka_helm:            { id: 'baranka_helm',            name: '바란카의 투구',        type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 400,  bonuses: { con: 1 }, bonusEffects: ['CON +1'] },
  red_knight_hood:         { id: 'red_knight_hood',         name: '붉은 기사의 두건',     type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 600 },
  orc_helm:                { id: 'orc_helm',                name: '오크족 투구',          type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 75 },
  studded_leather_hat:     { id: 'studded_leather_hat',     name: '징박은 가죽모자',      type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 70 },
  kurtz_helmet:            { id: 'kurtz_helmet',            name: '커츠의 투구',          type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 1000 },
  basic_helm:              { id: 'basic_helm',              name: '투구',                type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 100 },
  blue_pirate_hood:        { id: 'blue_pirate_hood',        name: '푸른 해적 두건',       type: 'helmet', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 150 },
  ...
  */
  orc_cloak:               { id: 'orc_cloak',               name: '오크족 망토',              type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 0, maxEnhance: 10, sellPrice: 25 },
  dwarf_cloak:             { id: 'dwarf_cloak',             name: '난쟁이족 망토',            type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 0, maxEnhance: 10, sellPrice: 52 },
  vampire_cloak:           { id: 'vampire_cloak',           name: '뱀파이어의 망토',           type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 0, maxEnhance: 10, sellPrice: 25 },
  oil_cloak:               { id: 'oil_cloak',               name: '기름 망토',                type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 80,   bonuses: { hp: 10 }, bonusEffects: ['HP +10'] },
  elven_cloak:             { id: 'elven_cloak',             name: '요정족 망토',              type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 600 },
  ...
  demon_lord_cloak:        { id: 'demon_lord_cloak',        name: '명법군왕의 망토',           type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 5, maxEnhance: 10, sellPrice: 4000 },
  balrog_cloak:            { id: 'balrog_cloak',            name: '발록의 핏빛 망토',          type: 'cloak', baseAtk: 0, baseAtkLarge: 0, baseDef: 5, maxEnhance: 10, sellPrice: 5000 },
  ...
  */
  ...
  pirate_gloves:           { id: 'pirate_gloves',           name: '푸른 해적 장갑',        type: 'gloves', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 4000 },
  demon_gloves:            { id: 'demon_gloves',            name: '데몬의 장갑',           type: 'gloves', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 200 },
  dk_gloves:               { id: 'dk_gloves',               name: '데스나이트의 장갑',      type: 'gloves', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 280 },
  kurtz_gloves:            { id: 'kurtz_gloves',            name: '커츠의 장갑',           type: 'gloves', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 900 },
  ...
  assassin_gloves:         { id: 'assassin_gloves',         name: '암살군왕의 장갑',        type: 'gloves', baseAtk: 0, baseAtkLarge: 0, baseDef: 4, maxEnhance: 10, sellPrice: 3000 },
  ...
  */
  leather_sandals:         { id: 'leather_sandals',         name: '가죽샌달',              type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 0, maxEnhance: 10, sellPrice: 8 },
  studded_sandals:         { id: 'studded_sandals',         name: '징박은 가죽샌달',        type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 20 },
  short_boots:             { id: 'short_boots',             name: '짧은 부츠',             type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 150 },
  boots:                   { id: 'boots',                   name: '부츠',                  type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 1000 },
  leather_boots:           { id: 'leather_boots',           name: '가죽부츠',              type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 65 },
  lastabad_boots:          { id: 'lastabad_boots',          name: '라스타바드 부츠',        type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 750 },
  pirate_boots:            { id: 'pirate_boots',            name: '푸른 해적 부츠',         type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 1500 },
  steel_boots:             { id: 'steel_boots',             name: '강철 부츠',             type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 320 },
  demon_boots:             { id: 'demon_boots',             name: '데몬의 부츠',            type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 350 },
  dk_boots:                { id: 'dk_boots',                name: '데스나이트의 부츠',       type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 400 },
  baranka_boots:           { id: 'baranka_boots',           name: '바란카의 부츠',          type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 450 },
  kurtz_boots:             { id: 'kurtz_boots',             name: '커츠의 부츠',            type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 1100 },
  beast_lord_boots:        { id: 'beast_lord_boots',        name: '마수군왕의 부츠',         type: 'boots', baseAtk: 0, baseAtkLarge: 0, baseDef: 4, maxEnhance: 10, sellPrice: 2500 },
  ...
  */
  small_shield:            { id: 'small_shield',            name: '작은 방패',             type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 30 },
  leather_shield:          { id: 'leather_shield',          name: '가죽방패',              type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 15 },
  wooden_shield:           { id: 'wooden_shield',           name: '나무방패',              type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 18 },
  orc_shield:              { id: 'orc_shield',              name: '우럭하이 방패',          type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 1, maxEnhance: 10, sellPrice: 45 },
  dwarf_shield:            { id: 'dwarf_shield',            name: '난쟁이족 둥근 방패',     type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 125 },
  studded_shield:          { id: 'studded_shield',          name: '징박은 가죽방패',        type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 50 },
  large_shield:            { id: 'large_shield',            name: '큰 방패',               type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 600 },
  medusa_shield:           { id: 'medusa_shield',           name: '메두사 방패',            type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 2, maxEnhance: 10, sellPrice: 120,  bonusEffects: ['석화 내성+30 (미구현)'] },
  steel_shield:            { id: 'steel_shield',            name: '강철 방패',             type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 350 },
  gollack_shield:          { id: 'gollack_shield',          name: '골각방패',              type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 0, sellPrice: 200 },
  eva_shield:              { id: 'eva_shield',              name: '에바의 방패',            type: 'shield', baseAtk: 0, baseAtkLarge: 0, baseDef: 3, maxEnhance: 10, sellPrice: 1300, bonuses: { hp: 20 }, bonusEffects: ['HP +20', '헤이스트 (미구현)'] },
