...
const HAND_CURATED_TEMPLATES: Record<string, Omit<EquipmentTemplate, 'safeEnchant'> & { safeEnchant?: number }> = {
  ...
  */
  ...
  duke_two_hand:       { id: 'duke_two_hand',       name: '킹 버그베어의 양손검',         type: 'weapon', baseAtk: 19, baseAtkLarge: 23, baseDef: 0, maxEnhance: 10, sellPrice: 15000, weight: 150000, isTwoHanded: true, classRestriction: ['knight'], bonuses: { hit: 1, extraDmg: 5 }, bonusEffects: ['명중+1', '추타+5'] },
  great_sword:         { id: 'great_sword',         name: '오우거의 대검',        type: 'weapon', baseAtk: 20, baseAtkLarge: 17, baseDef: 0, maxEnhance: 10, sellPrice: 15000, weight: 150000, isTwoHanded: true, classRestriction: ['knight'], bonuses: { extraDmg: 3 }, bonusEffects: ['추타+3'] },
  ...
  nightvald_two_hand:  { id: 'nightvald_two_hand',  name: '좀비 엘모어 마샬의 양손검',   type: 'weapon', baseAtk: 22, baseAtkLarge: 28, baseDef: 0, maxEnhance: 10, sellPrice: 10000, weight: 100000, isTwoHanded: true, classRestriction: ['knight'], bonuses: { hit: -1, extraDmg: 6, str: 1 }, bonusEffects: ['명중-1', '추타+6', 'STR+1'] },
  dragon_slayer:       { id: 'dragon_slayer',       name: '테라 드래곤의 대검',       type: 'weapon', baseAtk: 24, baseAtkLarge: 33, baseDef: 0, maxEnhance: 10, sellPrice: 18000, weight: 180000, isTwoHanded: true, classRestriction: ['knight'] },
  ancient_great_sword: { id: 'ancient_great_sword', name: '라스타바드 성역의 고대 대검',          type: 'weapon', baseAtk: 27, baseAtkLarge: 45, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 7000,  weight: 70000, isTwoHanded: true, classRestriction: ['knight'], bonuses: { hit: 3, extraDmg: 3 }, bonusEffects: ['명중+3', '추타+3'], minLevel: 45 },
  ...
  girtas_sword:        { id: 'girtas_sword',        name: '이계의 신 기르타스의 검',         type: 'weapon', baseAtk: 43, baseAtkLarge: 53, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 10000, weight: 100000, isTwoHanded: true, classRestriction: ['knight'], bonuses: { hit: 7, extraDmg: 30, str: 2, con: 1, unbreakable: true }, bonusEffects: ['명중+7', '추타+30', 'STR+2', 'CON+1', '손상되지 않음'] },
  ...
  black_bow:           { id: 'black_bow',           name: '다크 엘프 레인저의 활',            type: 'bow', baseAtk: 3, baseAtkLarge: 2, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 5, bowDmg: 2, unbreakable: true }, bonusEffects: ['활 명중+5', '활 추타+2', '손상되지 않음'] },
  crossbow:            { id: 'crossbow',            name: '오크 스카우트의 활',          type: 'bow', baseAtk: 3, baseAtkLarge: 2, baseDef: 0, maxEnhance: 10, sellPrice: 5000,  weight: 50000, isTwoHanded: true, classRestriction: ['knight', 'elf'], bonuses: { bowHit: 3, bowDmg: 2, unbreakable: true }, bonusEffects: ['활 명중+3', '활 추타+2', '손상되지 않음'] },
  long_bow:            { id: 'long_bow',            name: '어둠 숲지기의 장궁',                type: 'bow', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowDmg: 3, unbreakable: true }, bonusEffects: ['활 추타+3', '손상되지 않음'] },
  flame_bow:           { id: 'flame_bow',           name: '불타는 궁수의 화궁',            type: 'bow', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 3000,  weight: 30000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 2, bowDmg: 4, unbreakable: true, undeadSlayer: true }, bonusEffects: ['활 명중+2', '활 추타+4', '손상되지 않음', '언데드 추타'], minLevel: 50 },
  crimson_crossbow:    { id: 'crimson_crossbow',    name: '해골 궁수의 쇠뇌',     type: 'bow', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 2500,  weight: 25000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 1, unbreakable: true }, bonusEffects: ['활 명중+1', '손상되지 않음'], minLevel: 40 },
  ...
  changcheon_bow:      { id: 'changcheon_bow',      name: '심연의 풍령의 활',            type: 'bow', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 6000,  weight: 60000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 2, bowDmg: 8, unbreakable: true }, bonusEffects: ['활 명중+2', '활 추타+8', '손상되지 않음'] },
  tebe_bow:            { id: 'tebe_bow',            name: '테베 만드라고라의 활',    type: 'bow', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 500,   weight: 5000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowDmg: 1, int: 2, wis: 1, unbreakable: true }, bonusEffects: ['활 추타+1', 'INT+2', 'WIS+1', '손상되지 않음'] },
  black_king_bow:      { id: 'black_king_bow',      name: '어둠의 군주의 장궁',              type: 'bow', baseAtk: 4, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 5000,  weight: 50000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 4, bowDmg: 6, unbreakable: true }, bonusEffects: ['활 명중+4', '활 추타+6', '손상되지 않음'] },
  sayha_bow:           { id: 'sayha_bow',           name: '풍령의 주인의 활',          type: 'bow', baseAtk: 4, baseAtkLarge: 4, baseDef: 0, maxEnhance: 10, sellPrice: 3000,  weight: 30000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 2, bowDmg: 5, unbreakable: true }, bonusEffects: ['활 명중+2', '활 추타+5', '손상되지 않음'] },
  ...
  salcheon_bow:        { id: 'salcheon_bow',        name: '정예 다크 엘프 패잔병의 궁',            type: 'bow', baseAtk: 5, baseAtkLarge: 5, baseDef: 0, maxEnhance: 10, sellPrice: 3000,  weight: 30000, isTwoHanded: true, classRestriction: ['elf'], bonuses: { bowHit: 8, bowDmg: 8, unbreakable: true }, bonusEffects: ['활 명중+8', '활 추타+8', '손상되지 않음'], minLevel: 52 },
  ...
  black_wizard_staff:  { id: 'black_wizard_staff',  name: '암흑 마법사의 스태프',  type: 'staff', baseAtk: 1, baseAtkLarge: 1, baseDef: 0, maxEnhance: 10, sellPrice: 1500,  weight: 15000, classRestriction: ['wizard'], bonuses: { sp: 2, mpr: 5, unbreakable: true }, bonusEffects: ['SP+2', 'MPR+5', '손상되지 않음'] },
  raia_wand:           { id: 'raia_wand',           name: '라스타바드 조련사의 완드', type: 'staff', baseAtk: 1, baseAtkLarge: 1, baseDef: 0, maxEnhance: 10, sellPrice: 1500,  weight: 15000, classRestriction: ['wizard'], bonuses: { hit: -3, sp: 1, mpr: 10, unbreakable: true, haste: true }, bonusEffects: ['명중-3', 'SP+1', 'MPR+10', '손상되지 않음', '헤이스트'] },
  ...
  demon_staff:         { id: 'demon_staff',         name: '악마의 신전 데몬 스태프',         type: 'staff', baseAtk: 1, baseAtkLarge: 1, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 100,   weight: 1000, classRestriction: ['wizard'], bonuses: { sp: 5, unbreakable: true }, bonusEffects: ['SP+5', '손상되지 않음'] },
  ice_queen_staff:     { id: 'ice_queen_staff',     name: '얼음 여왕의 지팡이',    type: 'staff', baseAtk: 2, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 2000,  weight: 20000, classRestriction: ['wizard'], bonuses: { hit: -1, unbreakable: true }, bonusEffects: ['명중-1', '손상되지 않음', '아이시클 패시브'] },
  ...
  beres_staff:         { id: 'beres_staff',         name: '베레스의 악마 지팡이',       type: 'staff', baseAtk: 2, baseAtkLarge: 3, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 1500,  weight: 15000, classRestriction: ['wizard'], bonuses: { sp: 2, mpr: 10, unbreakable: true }, bonusEffects: ['SP+2', 'MPR+10', '손상되지 않음'] },
  baphomet_staff:      { id: 'baphomet_staff',      name: '포노스 오크 주술사의 지팡이',     type: 'staff', baseAtk: 2, baseAtkLarge: 3, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 1500,  weight: 15000, classRestriction: ['wizard'], bonuses: { hit: 7, extraDmg: 5, unbreakable: true }, bonusEffects: ['명중+7', '추타+5', '손상되지 않음'] },
  mana_staff:          { id: 'mana_staff',          name: '심해의 마나 지팡이',     type: 'staff', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 1500,  weight: 15000, classRestriction: ['wizard'], bonuses: { hit: -3, unbreakable: true }, bonusEffects: ['명중-3', '손상되지 않음', 'MP 흡수'] },
  steel_mana_staff:    { id: 'steel_mana_staff',    name: '지저 비홀더의 마나 지팡이', type: 'staff', baseAtk: 3, baseAtkLarge: 3, baseDef: 0, maxEnhance: 10, sellPrice: 3000,  weight: 30000, classRestriction: ['wizard'], bonuses: { hit: 2, unbreakable: true }, bonusEffects: ['명중+2', '손상되지 않음', 'MP 흡수'] },
  changcheon_staff:    { id: 'changcheon_staff',    name: '심연의 수령의 지팡이',         type: 'staff', baseAtk: 8, baseAtkLarge: 5, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 8000,  weight: 80000, classRestriction: ['wizard'], bonuses: { extraDmg: 5, sp: 1, mpr: 8, unbreakable: true }, bonusEffects: ['추타+5', 'SP+1', 'MPR+8', '손상되지 않음'] },
