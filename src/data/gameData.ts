...
const HAND_CURATED_TEMPLATES: Record<string, Omit<EquipmentTemplate, 'safeEnchant'> & { safeEnchant?: number }> = {
  ...
  */
  ...
  // ── 한손검 (19종, type: weapon) ──
  mail_breaker:        { id: 'mail_breaker',        name: '메일 브레이커',        type: 'weapon', baseAtk: 4,  baseAtkLarge: 5,  baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, bonuses: { hit: 10, undeadSlayer: true }, bonusEffects: ['명중+10', '언데드 추타'] },
  silver_long_sword:   { id: 'silver_long_sword',   name: '은장검',              type: 'weapon', baseAtk: 8,  baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 5000,  weight: 50000, bonuses: { undeadSlayer: true }, bonusEffects: ['언데드 추타'] },
  red_knight_sword:    { id: 'red_knight_sword',    name: '붉은 기사의 검',       type: 'weapon', baseAtk: 8,  baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, bonuses: { str: 1 }, bonusEffects: ['STR+1'] },
  damascus_sword:      { id: 'damascus_sword',      name: '다마스커스 검',        type: 'weapon', baseAtk: 10, baseAtkLarge: 11, baseDef: 0, maxEnhance: 10, sellPrice: 4500,  weight: 45000, classRestriction: ['knight', 'elf'], bonuses: { unbreakable: true }, bonusEffects: ['손상되지 않음'] },
  lastabad_long_sword: { id: 'lastabad_long_sword', name: '라스타바드 장검',      type: 'weapon', baseAtk: 10, baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 3000,  weight: 30000, classRestriction: ['knight', 'elf'], bonuses: { hit: 1 }, bonusEffects: ['명중+1'] },
  cutlass:             { id: 'cutlass',             name: '커트라스',            type: 'weapon', baseAtk: 10, baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 5000,  weight: 50000, classRestriction: ['knight', 'elf'], bonuses: { hit: 1, unbreakable: true }, bonusEffects: ['명중+1', '손상되지 않음'] },
  katana:              { id: 'katana',              name: '일본도',              type: 'weapon', baseAtk: 10, baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, classRestriction: ['knight', 'elf'], bonuses: { hit: 1 }, bonusEffects: ['명중+1'] },
  rapier:              { id: 'rapier',              name: '레이피어',            type: 'weapon', baseAtk: 11, baseAtkLarge: 6,  baseDef: 0, maxEnhance: 10, sellPrice: 6000,  weight: 60000, classRestriction: ['knight', 'elf'] },
  shamshir:            { id: 'shamshir',            name: '샴쉬르',              type: 'weapon', baseAtk: 11, baseAtkLarge: 6,  baseDef: 0, maxEnhance: 10, sellPrice: 6000,  weight: 60000, classRestriction: ['knight', 'elf'], bonuses: { hit: 1 }, bonusEffects: ['명중+1'] },
  dark_elf_sword:      { id: 'dark_elf_sword',      name: '고대 다크엘프의 검',   type: 'weapon', baseAtk: 12, baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 2000,  weight: 20000, classRestriction: ['elf'], bonuses: { hit: 3, extraDmg: 1, dex: 1, hp: 50, undeadSlayer: true }, bonusEffects: ['명중+3', '추타+1', 'DEX+1', 'HP+50', '언데드 추타'] },
  changcheon_sword:    { id: 'changcheon_sword',    name: '창천의 검',            type: 'weapon', baseAtk: 12, baseAtkLarge: 12, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 2000,  weight: 20000, classRestriction: ['knight', 'elf'], bonuses: { hit: 2, extraDmg: 5 }, bonusEffects: ['명중+2', '추타+5'] },
  mugwan_sword:        { id: 'mugwan_sword',        name: '무관의 장검',          type: 'weapon', baseAtk: 13, baseAtkLarge: 10, baseDef: 0, maxEnhance: 10, sellPrice: 12000, weight: 120000, classRestriction: ['knight', 'elf'], bonuses: { hit: 1, extraDmg: 2 }, bonusEffects: ['명중+1', '추타+2'] },
  thunder_sword:       { id: 'thunder_sword',       name: '뇌 신검',             type: 'weapon', baseAtk: 13, baseAtkLarge: 12, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, classRestriction: ['knight', 'elf'], bonuses: { hit: 1, extraDmg: 1, unbreakable: true }, bonusEffects: ['명중+1', '추타+1', '손상되지 않음'] },
  kurtz_sword:         { id: 'kurtz_sword',         name: '커츠의 검',            type: 'weapon', baseAtk: 15, baseAtkLarge: 11, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, classRestriction: ['knight'], bonuses: { hit: 4, extraDmg: 5, unbreakable: true }, bonusEffects: ['명중+4', '추타+5', '손상되지 않음'] },
  death_blade:         { id: 'death_blade',         name: '데스 블레이드',        type: 'weapon', baseAtk: 16, baseAtkLarge: 8,  baseDef: 0, maxEnhance: 10, sellPrice: 10000, weight: 100000, classRestriction: ['knight'], bonuses: { hit: 2, unbreakable: true }, bonusEffects: ['명중+2', '손상되지 않음'], minLevel: 50 },
  oriharukon_sword:    { id: 'oriharukon_sword',    name: '싸울아비 장검',        type: 'weapon', baseAtk: 16, baseAtkLarge: 10, baseDef: 0, maxEnhance: 10, sellPrice: 12000, weight: 120000, classRestriction: ['knight'], bonuses: { hit: 2 }, bonusEffects: ['명중+2'] },
  dk_flame_sword:      { id: 'dk_flame_sword',      name: '데스 나이트의 불검',   type: 'weapon', baseAtk: 16, baseAtkLarge: 10, baseDef: 0, maxEnhance: 10, sellPrice: 4000,  weight: 40000, classRestriction: ['knight'], bonuses: { hit: 5, extraDmg: 2 }, bonusEffects: ['명중+5', '추타+2'] },
  doom_blade:          { id: 'doom_blade',          name: '둠 블레이드',          type: 'weapon', baseAtk: 16, baseAtkLarge: 16, baseDef: 0, maxEnhance: 10, sellPrice: 5000,  weight: 50000, bonuses: { hit: 20, extraDmg: 120, str: 5, dex: 5, con: 5, int: 5, wis: 5, unbreakable: true }, bonusEffects: ['명중+20', '추타+120', 'STR+5', 'DEX+5', 'CON+5', 'INT+5', 'WIS+5', '손상되지 않음'], minLevel: 52 },
  ancient_sword:       { id: 'ancient_sword',       name: '고대의 검',            type: 'weapon', baseAtk: 35, baseAtkLarge: 20, baseDef: 0, safeEnchant: 0, maxEnhance: 10, sellPrice: 3000,  weight: 30000, classRestriction: ['knight', 'elf'], bonuses: { hit: 5 }, bonusEffects: ['명중+5'], minLevel: 45 },
